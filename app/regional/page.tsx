    ...
    return (
      <div className="max-w-xl mx-auto py-10">
        <Card className="p-8 text-center space-y-4">
          ...
          <h1 className="text-xl font-bold text-white">Awaiting region assignment</h1>
          ...
          {requestedRegionCode
            ? <p className="text-sm text-slate-300">Region code you entered: <span className="font-semibold text-[#C6A35D]">{requestedRegionCode}</span>. If this is wrong, update it in Settings.</p>
