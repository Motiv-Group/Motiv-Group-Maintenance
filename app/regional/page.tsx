    ...
    return (
      <div className="max-w-xl mx-auto py-10">
        <Card className="p-8 text-center space-y-4">
          ...
          {requestedRegionCode
            ? <p className="text-sm text-[var(--text-muted)]">Region code you entered: <span className="font-semibold text-[#f59e0b]">{requestedRegionCode}</span>. If this is wrong, update it in Settings.</p>
            : <p className="text-sm text-amber-400">No region code on file — add the code your executive gave you in Settings.</p>}
          <Link href="/settings" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-600 text-white text-sm font-semibold hover:brightness-95 transition">
