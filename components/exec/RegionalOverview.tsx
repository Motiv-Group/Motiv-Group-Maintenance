...
import { Building2, ShieldAlert, Truck, ClipboardCheck, AlertTriangle, ListTodo, Sparkles, Banknote } from 'lucide-react'
import type { RegionalDashboardData } from '@/lib/health/data'
import { SectionCard, Pill, Card, DistributionBar, RagBlocks, STATUS_TEXT } from '@/components/exec/ui'
...
export function RegionalOverview({ data, name, briefing, briefingScopeId }: { data: RegionalDashboardData; name: string | null; briefing?: Briefing; briefingScopeId?: string }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <RegionalPriorityWorkQueue tickets={data.tickets} generatedAt={data.generatedAt} />
