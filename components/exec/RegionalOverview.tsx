...
export function RegionalOverview({ data, name, briefing, briefingScopeId, motivSuppliers = [], motivAccess = 'none', chatUnread = {} }: { data: RegionalDashboardData; name: string | null; briefing?: Briefing; briefingScopeId?: string; motivSuppliers?: { id: string; name: string; avgRating?: number; ratingCount?: number; category?: string | null }[]; motivAccess?: 'none' | 'pending' | 'approved' | 'rejected'; chatUnread?: Record<string, number> }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <RegionalPriorityWorkQueue tickets={data.tickets} generatedAt={data.generatedAt} suppliers={assignSuppliers} motivSuppliers={motivSuppliers} motivAccess={motivAccess} chatUnread={chatUnread} />
