...
import { downloadMedia, transcribeAndExtract, extractTicketFields, uploadPhotoToStorage } from '@/lib/whatsapp/ai';
import {
  CATEGORIES, IMPACTS, CONFIDENCE_THRESHOLD, impactToPriority,
  type Category, type OpImpact, type V3Priority, type ExtractedTicket,
} from '@/lib/whatsapp/extract';
...
export async function handleWebhook(payload: WaPayload) {
  try {
