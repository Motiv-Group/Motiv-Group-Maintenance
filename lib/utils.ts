...
export const STATUS_COLORS: Record<TicketStatus, string> = {
  ...
  in_progress: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400',
...
export const STATUS_PILL: Record<TicketStatus, { active: string; inactive: string }> = {
  ...
  in_progress: { active: 'bg-emerald-500 text-white border-emerald-500', inactive: 'text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-900/40 hover:border-emerald-400' },
