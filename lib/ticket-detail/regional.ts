...
async function buildRegionalTicketDetail(
  ...
  const archivedGroups = { archivedDeclinedQuotes, archivedRequestDeclines, closedWaitingRows, supersededSubmissions, declinedSnag, variations: (variations ?? []) as any[] }
  ...
  return {
    ...
    latestSnag, snagScheduledAt, snagAwaitingApproval, snagFixApproved, snagScheduleActive, declinedSnag,
